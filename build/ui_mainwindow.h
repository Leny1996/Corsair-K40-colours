...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnCancel->setGeometry(QRect(310, 340, 96, 31));
        QPalette palette1;
        ...
        btnUpdate->setGeometry(QRect(460, 340, 96, 31));
        QPalette palette2;
        ...
        lblTitle->setGeometry(QRect(20, 0, 541, 21));
        QFont font;
        ...
        lblStatus->setGeometry(QRect(10, 390, 571, 31));
        QFont font1;
        ...
        lblVersion->setGeometry(QRect(490, 10, 71, 20));
        ...
        groupFavourites->setGeometry(QRect(20, 190, 421, 71));
        ...
        lblStatus_2->setGeometry(QRect(10, 280, 131, 20));
